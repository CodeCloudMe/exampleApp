...
/**
 * RecentlySearched Schema
 */

var RecentlySearchedSchema = new Schema({
...
//RecentlySearchedSchema.index({type: 1, location: 1});
RecentlySearchedSchema.index({ location: '2dsphere' });
RecentlySearchedSchema.index({ loc: '2dsphere' });
RecentlySearchedSchema.index({ type: 'Point' });
...
RecentlySearchedSchema.path('title').required(true, 'RecentlySearched title cannot be blank');
RecentlySearchedSchema.path('body').required(true, 'RecentlySearched body cannot be blank');

/**
 * Pre-remove hook
 */

RecentlySearchedSchema.pre('remove', function (next) {
  /*
...
RecentlySearchedSchema.methods = {

  /**
   * Save recentlySearched and upload image
   *
   * @param {Object} images
   * @param {Function} cb
   * @api private
...
RecentlySearchedSchema.statics = {

  /**
   * Find recentlySearched by id
   *
   * @param {ObjectId} id
   * @param {Function} cb
   * @api private
...
mongoose.model('RecentlySearched', RecentlySearchedSchema);
