...
//ResultSchema.index({type: 1, location: 1});
ResultSchema.index({ location: '2dsphere' });
ResultSchema.index({ loc: '2dsphere' });
ResultSchema.index({ type: 'Point' });
...
ResultSchema.path('title').required(true, 'Result title cannot be blank');
ResultSchema.path('body').required(true, 'Result body cannot be blank');
